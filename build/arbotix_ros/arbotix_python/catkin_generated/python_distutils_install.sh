...
echo_and_run cd "/home/optobot/DEMO05_WS/src/arbotix_ros/arbotix_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/optobot/DEMO05_WS/src/arbotix_ros/arbotix_python/setup.py" \
    egg_info --egg-base /home/optobot/DEMO05_WS/build/arbotix_ros/arbotix_python \
    build --build-base "/home/optobot/DEMO05_WS/build/arbotix_ros/arbotix_python" \
    install \
    --root="${DESTDIR-/}" \
